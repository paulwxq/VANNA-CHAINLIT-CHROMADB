...
bss_service_area 表`bss_service_area` 表用于存储高速公路服务区的基本信息，包括服务区名称、编码、版本控制及操作记录，为核心业务系统提供基础数据支撑。
字段列表：
...
- service_position (varchar(255)) - 服务区经纬度坐标 [示例: 114.574721,26.825584, 115.910549,28.396355]
